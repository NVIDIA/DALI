...
class DecoderPipeline(Pipeline):
    def __init__(self):
        super().__init__(batch_size=8,
                         ...
                         exec_pipelined=True,
                         output_dtype=[
                             types.INT16, types.INT16, types.INT16, types.FLOAT, types.FLOAT,
        ...
        self.resampling_downmixing_decoder = ops.decoders.Audio(sample_rate=rate2,
                                                                downmix=True,
                                                                quality=50,
                                                                dtype=types.FLOAT)
    ...
    def define_graph(self):
        ...
        out = [
            dec_plain, dec_res, dec_mix, dec_res_mix, rates_plain, rates_res, rates_mix,
            rates_res_mix
        ]
        return out
...
def decoder_pipe(decoder_op, fnames, sample_rate, downmix, quality, dtype):
    ...
    decoded, rates = decoder_op(encoded,

...
def test_pytorch_iterator_feed_ndarray_types(data_type):
...
def test_paddle_iterator_feed_ndarray_types(data_type):
...
@cartesian_params(
    [3, 5, 17],  # shards_num
    [1, 3, 5, 7, 17],  # pipes_number: 1 and shards_num for each shards_num
    [3, 5, 7],  # batch_size
...
@attr("pytorch")
@params((True,), (False,))
def test_pytorch_iterator_pass_reader_name_autoreset(auto_reset):
    check_pytorch_iterator_pass_reader_name(
        3,
        1,
        3,
...
@attr("paddle")
@params((True,), (False,))
def test_paddle_iterator_pass_reader_name_autoreset(auto_reset):
    check_paddle_iterator_pass_reader_name(
        3,
        1,
        3,

...
def test_roi_random_crop_error_incompatible_args():
    ...
    yield check_roi_random_crop_error, np.zeros(in_shape), None, crop_shape, roi_start, \
        roi_shape, roi_end, "Either ROI end or ROI shape should be defined, but not both"

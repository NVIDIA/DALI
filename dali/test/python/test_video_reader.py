...
@cartesian_params(devices, batch_sizes, sequence_lengths)
def test_compare_experimental_to_legacy_reader_filenames(device, batch_size, sequence_length):
...
@cartesian_params(devices, batch_sizes, sequence_lengths, file_list_formats)
def test_compare_experimental_to_legacy_reader_file_list(
    device, batch_size, sequence_length, file_list_format
):
...
@cartesian_params(devices, batch_sizes, sequence_lengths)
def test_compare_experimental_to_legacy_reader_file_root(device, batch_size, sequence_length):
    if debug:

...
@eval_modes()
@params((1 << 32, 1 << 32), ([0, 5_000_000_000], 5_000_000_000))
def test_broadcast_int_overflow(data, faulty_value):
    with assert_raises(OverflowError, glob=f"*{faulty_value}*out of range for uint32*"):

...
#ifndef TENSORFLOW_CORE_UTIL_MANAGED_STACK_TRACE_H_  // NOLINT(build/header_guard)
#define TENSORFLOW_CORE_UTIL_MANAGED_STACK_TRACE_H_  // NOLINT(build/header_guard)
...
#endif  // TENSORFLOW_CORE_UTIL_MANAGED_STACK_TRACE_H_  // NOLINT(build/header_guard)

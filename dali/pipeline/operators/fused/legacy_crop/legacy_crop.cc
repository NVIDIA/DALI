...
template <>
LegacyCrop<CPUBackend>::LegacyCrop(const OpSpec &spec)
...
template <>
void LegacyCrop<CPUBackend>::RunImpl(SampleWorkspace *ws, const int idx) {
...
template <>
void LegacyCrop<CPUBackend>::SetupSharedSampleParams(SampleWorkspace *ws) {
...
// Register operator
DALI_REGISTER_OPERATOR(LegacyCrop, LegacyCrop<CPUBackend>, CPU);

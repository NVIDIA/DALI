...
#ifndef DALI_PIPELINE_OPERATORS_FUSED_LEGACY_CROP_KERNEL_SEQUENCE_H_
#define DALI_PIPELINE_OPERATORS_FUSED_LEGACY_CROP_KERNEL_SEQUENCE_H_
...
#endif  // DALI_PIPELINE_OPERATORS_FUSED_LEGACY_CROP_KERNEL_SEQUENCE_H_

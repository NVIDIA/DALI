...
#ifndef DALI_PIPELINE_OPERATORS_FUSED_LEGACY_CROP_LEGACY_CROP_H_
#define DALI_PIPELINE_OPERATORS_FUSED_LEGACY_CROP_LEGACY_CROP_H_
...
class LegacyCrop : public Operator<Backend>, protected CropAttr {
 public:
  explicit inline LegacyCrop(const OpSpec &spec) :
...
#endif  // DALI_PIPELINE_OPERATORS_FUSED_LEGACY_CROP_LEGACY_CROP_H_

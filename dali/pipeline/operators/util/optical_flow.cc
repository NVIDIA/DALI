...
//        of_params_({}),
//        optical_flow_(std::unique_ptr<optical_flow::OpticalFlowAdapter>(
//                new optical_flow::OpticalFlowStub(of_params_))) {
//}
...
////  kernels::TensorView<kernels::StorageCPU, const uint8_t, 3> tvin;
//

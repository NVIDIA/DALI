...
#ifndef DALI_PIPELINE_OPERATORS_UTIL_LOOKUP_TABLE_H_
#define DALI_PIPELINE_OPERATORS_UTIL_LOOKUP_TABLE_H_
...
#endif  // DALI_PIPELINE_OPERATORS_UTIL_LOOKUP_TABLE_H_

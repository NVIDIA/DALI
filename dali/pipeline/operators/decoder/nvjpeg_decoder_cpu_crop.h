...
#ifndef DALI_PIPELINE_OPERATORS_DECODER_NVJPEG_DECODER_CPU_CROP_H_
#define DALI_PIPELINE_OPERATORS_DECODER_NVJPEG_DECODER_CPU_CROP_H_
...
#endif  // DALI_PIPELINE_OPERATORS_DECODER_NVJPEG_DECODER_CPU_CROP_H_

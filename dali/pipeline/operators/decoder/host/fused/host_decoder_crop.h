...
#ifndef DALI_PIPELINE_OPERATORS_DECODER_HOST_FUSED_HOST_DECODER_CROP_H_
#define DALI_PIPELINE_OPERATORS_DECODER_HOST_FUSED_HOST_DECODER_CROP_H_
...
#endif  // DALI_PIPELINE_OPERATORS_DECODER_HOST_FUSED_HOST_DECODER_CROP_H_

...
#ifndef DALI_OPERATORS_DISPLACEMENT_WARP_PARAM_PROVIDER_H_
#define DALI_OPERATORS_DISPLACEMENT_WARP_PARAM_PROVIDER_H_
...
#endif  // DALI_OPERATORS_DISPLACEMENT_WARP_PARAM_PROVIDER_H_

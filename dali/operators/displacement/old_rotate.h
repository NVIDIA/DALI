...
#ifndef DALI_OPERATORS_DISPLACEMENT_OLD_ROTATE_H_
#define DALI_OPERATORS_DISPLACEMENT_OLD_ROTATE_H_
...
class OldRotate : public DisplacementFilter<Backend, RotateAugment> {
 public:
  inline explicit OldRotate(const OpSpec &spec)
    : DisplacementFilter<Backend, RotateAugment>(spec) {}

  ~OldRotate() override = default;
};

}  // namespace dali

#endif  // DALI_OPERATORS_DISPLACEMENT_OLD_ROTATE_H_

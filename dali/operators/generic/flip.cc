...
DALI_SCHEMA(Flip)
    ...
    .NumInput(1)
    .NumOutput(1)
    .AddOptionalArg("horizontal", R"code(Flip the vertical dimension.)code", 1, true)
    .AddOptionalArg("vertical", R"code(Flip the horizontal dimension.)code", 0, true)
    .AddOptionalArg("depthwise", R"code(Flip the depth-wise dimension.)code", 0, true)

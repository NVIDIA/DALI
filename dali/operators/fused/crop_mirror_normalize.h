...
#ifndef DALI_OPERATORS_FUSED_CROP_MIRROR_NORMALIZE_H_
#define DALI_OPERATORS_FUSED_CROP_MIRROR_NORMALIZE_H_
...
#endif  // DALI_OPERATORS_FUSED_CROP_MIRROR_NORMALIZE_H_

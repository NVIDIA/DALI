...
#ifndef DALI_OPERATORS_OPTICAL_FLOW_TURING_OF_UTILS_H_
#define DALI_OPERATORS_OPTICAL_FLOW_TURING_OF_UTILS_H_
...
#endif  // DALI_OPERATORS_OPTICAL_FLOW_TURING_OF_UTILS_H_

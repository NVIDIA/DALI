...
#ifndef DALI_OPERATORS_OPTICAL_FLOW_OPTICAL_FLOW_H_
#define DALI_OPERATORS_OPTICAL_FLOW_OPTICAL_FLOW_H_
...
class OpticalFlow : public Operator<Backend> {
 ...
 public:
  explicit OpticalFlow(const OpSpec &spec) :
          ...
          frames_width_(-1), frames_height_(-1), depth_(-1), nsequences_(-1), hints_width_(-1),
          hints_height_(-1), hints_depth_(-1) {
...
#endif  // DALI_OPERATORS_OPTICAL_FLOW_OPTICAL_FLOW_H_

...
DALI_SCHEMA(legacy__ImageDecoder)
    .DocStr("Legacy alias for :meth:`decoders.image`.")
    .NumInput(1)
    .NumOutput(1)
    .AddParent("legacy__decoders__Image")
    .MakeDocPartiallyHidden()
    .Deprecate(
        "legacy__decoders__Image",
...
DALI_SCHEMA(legacy__ImageDecoderCrop)
    .DocStr("Legacy alias for :meth:`decoders.image_crop`.")
    .NumInput(1)
    .NumOutput(1)
    .AddParent("legacy__decoders__ImageCrop")
    .MakeDocPartiallyHidden()
    .Deprecate(
        "legacy__decoders__ImageCrop",
        R"code(In DALI 1.0 all decoders were moved into a dedicated :mod:`~nvidia.dali.fn.decoders`
submodule and renamed to follow a common pattern. This is a placeholder operator with identical
functionality to allow for backward compatibility.)code");  // Deprecated in 1.0

DALI_SCHEMA(legacy__ImageDecoderRandomCrop)
    .DocStr("Legacy alias for :meth:`decoders.image_random_crop`.")
    .NumInput(1)
    .NumOutput(1)
    .AddParent("legacy__decoders__ImageRandomCrop")
    .MakeDocPartiallyHidden()
    .Deprecate(
...
DALI_SCHEMA(legacy__ImageDecoderSlice)
    .DocStr("Legacy alias for :meth:`decoders.image_slice`.")
    .NumInput(1, 3)
    .NumOutput(1)
    .AddParent("legacy__decoders__ImageSlice")
    .MakeDocPartiallyHidden()
    .Deprecate(
        "legacy__decoders__ImageSlice",
        R"code(In DALI 1.0 all decoders were moved into a dedicated :mod:`~nvidia.dali.fn.decoders`
submodule and renamed to follow a common pattern. This is a placeholder operator with identical
functionality to allow for backward compatibility.)code");  // Deprecated in 1.0

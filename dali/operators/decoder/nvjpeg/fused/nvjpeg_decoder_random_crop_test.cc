...
class ImageDecoderRandomCropTest_GPU
: public DecodeTestBase<ImgType>, public OperatorWithRandomCrop<Operator<MixedBackend>> {
 public:
  ImageDecoderRandomCropTest_GPU()
    : OperatorWithRandomCrop<Operator<MixedBackend>>(

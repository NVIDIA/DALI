...
template <typename MemoryKind>
unique_ptr_t Allocate(mm::memory_resource<MemoryKind> *mr, std::thread::id thread_id, size_t size) {
...
template <>
unique_ptr_t Allocate<mm::memory_kind::device>(std::thread::id thread_id, size_t size) {

...
TEST_F(FramesDecoderGpuTest, NioTest_0) {
  auto memory_video = MemoryVideo("/home/awolant/Projects/DALI/dev/nio/test.mkv");
  ...
  ASSERT_EQ(decoder.NumFrames(), 50);
  ...
  for (int i = 0; i < 10; ++i) {
    ...
    SaveFrame(frame_cpu_buffer_.data(), i, 0, 0, "/home/awolant/Projects/DALI/dev/nio/frames", decoder.Width(), decoder.Height());
  }
}

// TEST_F(FramesDecoderGpuTest, NioTest_1) {
...
//   ASSERT_EQ(decoder.NumFrames(), 608);

//   for (int i = 0; i < 10; ++i) {
//     auto ret = decoder.ReadNextFrame(frame_gpu_buffer_.data(), true);
//     MemCopy(frame_cpu_buffer_.data(), frame_gpu_buffer_.data(), decoder.Width()*decoder.Height()*3);
//     SaveFrame(frame_cpu_buffer_.data(), i, 1, 0, "/home/awolant/Projects/DALI/dev/nio/frames", decoder.Width(), decoder.Height());
//   }
// }

// TEST_F(FramesDecoderGpuTest, NioTest_2) {
...
//   ASSERT_EQ(decoder.NumFrames(), 627);

//   for (int i = 0; i < 10; ++i) {
//     auto ret = decoder.ReadNextFrame(frame_gpu_buffer_.data(), true);
//     MemCopy(frame_cpu_buffer_.data(), frame_gpu_buffer_.data(), decoder.Width()*decoder.Height()*3);
//     SaveFrame(frame_cpu_buffer_.data(), i, 2, 0, "/home/awolant/Projects/DALI/dev/nio/frames", decoder.Width(), decoder.Height());
//   }
// }

// TEST_F(FramesDecoderGpuTest, NioTest_3) {
...
//     auto ret = decoder.ReadNextFrame(frame_gpu_buffer_.data(), true);
//     MemCopy(frame_cpu_buffer_.data(), frame_gpu_buffer_.data(), decoder.Width()*decoder.Height()*3);
//     SaveFrame(frame_cpu_buffer_.data(), i, 3, 0, "/home/awolant/Projects/DALI/dev/nio/frames", decoder.Width(), decoder.Height());
//   }
// }

// TEST_F(FramesDecoderGpuTest, NioTest_4) {
...
//   FramesDecoderGpu decoder(memory_video.data(), memory_video.size(), 0, false, -1, true);

//   RunSequentialTest(decoder, cfr_videos_[1], 3.0);
// }

// TEST_F(FramesDecoderGpuTest, NioTest_5) {
//   auto memory_video = MemoryVideo("/home/awolant/Projects/DALI/dev/nio/black.hevc");

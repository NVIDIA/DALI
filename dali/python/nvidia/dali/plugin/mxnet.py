...
class DALICGluonlassificationIterator(DALIGluonGenericIterator):
    """
    DALI iterator for classification tasks for Gluon. It returns 2 outputs
    (data and label) in the form of a NDArrays tuple.
    ...
    .. code-block:: python
       ...
       DALIGenericIterator(pipelines,
                           [DALIClassificationIterator.DENSE_TAG,
                            DALIClassificationIterator.DENSE_TAG],
                           size)
    ...
    output_types : list of str
                 ...
                 as the former will be returned as a single NDArray, the latter
                 will be returned as a list of NDArray.
                 Must be either DALIGenericIterator.DENSE_TAG
                 or DALIGenericIterator.SPARSE_TAG.
                 Length of output_types must match the number of the pipeline(s) output.
    size : int
          Number of samples in the epoch (Usually the size of the dataset).
    auto_reset : bool, optional, default = False
    ...
    def __init__(self,
        ...
        super(DALIClassificationIterator, self).__init__(pipelines,
                                                         [DALIClassificationIterator.DENSE_TAG,
                                                          DALIClassificationIterator.SPARSE_TAG],
                                                         size,
                                                         auto_reset = auto_reset,
                                                         fill_last_batch = fill_last_batch,
                                                         last_batch_padded = last_batch_padded)
...
# todo: Add validation for types of parameters
  def __init__(self, image_type=None, label_type=None, output_shape=None):
    ...
    if output_shape:
      ...
      raise ValueError('No value provided for parameter \'output_shape\'')

...
alignas(0x1000) thread_local volatile bool __dali_imgcodec_test_force_tls_align;

void __dali_imgcodec_test_force_tls_align_fun(void) {
  __dali_imgcodec_test_force_tls_align = 0;
}
#else
void __dali_imgcodec_test_force_tls_align_fun(void) {}
#endif
...
int main(int argc, char **argv) {
  __dali_imgcodec_test_force_tls_align_fun();

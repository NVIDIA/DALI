...
#ifndef DALI_IMGCODEC_DECODERS_NVJPEG_PERMUTE_LAYOUT_H_
#define DALI_IMGCODEC_DECODERS_NVJPEG_PERMUTE_LAYOUT_H_
...
#endif  // DALI_IMGCODEC_DECODERS_NVJPEG_PERMUTE_LAYOUT_H_

...
#ifndef DALI_KERNELS_IMGPROC_PasddaxwaasfffddaAR_TRANSFORMATION_GPU_H_
#define DALI_KERNELS_IMGPROC_PasddaxwaasfffddaAR_TRANSFORMATION_GPU_H_
...
//
  KernelRequirements
  Setup(KernelContext &context, const InTensorCPU<InputType, ndims_> &in, Mat tmatrix,
        Vec> tvector, const Roi<spatial_ndims>* rois = nullptr) {
...
//
  void Run(KernelContext &context, const OutTensorCPU<OutputType, spatial_ndims + 1> &out,
           const InTensorCPU<InputType, spatial_ndims + 1> &in, Mat> tmatrix,
           Vec tvector, const Roi<spatial_ndims>* rois = nullptr) {

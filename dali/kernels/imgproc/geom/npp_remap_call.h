...
inline auto npp_remap_call(const uint8_t* pSrc, NppiSize oSrcSize, int nSrcStep, NppiRect oSrcROI,
...
inline auto npp_remap_call(const uint16_t* pSrc, NppiSize oSrcSize, int nSrcStep, NppiRect oSrcROI,
                           const float* pXMap, int nXMapStep, const float* pYMap, int nYMapStep,
...
inline auto npp_remap_call(const int16_t* pSrc, NppiSize oSrcSize, int nSrcStep, NppiRect oSrcROI,
                           const float* pXMap, int nXMapStep, const float* pYMap, int nYMapStep,
...
inline auto npp_remap_call(const float* pSrc, NppiSize oSrcSize, int nSrcStep, NppiRect oSrcROI,
                           const float* pXMap, int nXMapStep, const float* pYMap, int nYMapStep,
...
inline auto npp_remap_call(const double* pSrc, NppiSize oSrcSize, int nSrcStep, NppiRect oSrcROI,

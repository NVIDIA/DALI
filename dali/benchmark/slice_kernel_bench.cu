...
BENCHMARK_DEFINE_F(SliceBench, Slice_CPU_OnlySlice)(benchmark::State& st) {
  this->RunCPU(st);
}

BENCHMARK_REGISTER_F(SliceBench, Slice_CPU_OnlySlice)->Iterations(1000)
...
BENCHMARK_DEFINE_F(SliceBench, Slice_GPU_OnlySlice)(benchmark::State& st) {
  this->RunGPU(st);
}

BENCHMARK_REGISTER_F(SliceBench, Slice_GPU_OnlySlice)->Iterations(1000)
->Unit(benchmark::kMicrosecond)
->UseRealTime()
...
BENCHMARK_DEFINE_F(SliceBench, Slice_OnlyPad_CPU)(benchmark::State& st) {
  this->RunCPU(st);
}

BENCHMARK_REGISTER_F(SliceBench, Slice_OnlyPad_CPU)->Iterations(1000)
->Unit(benchmark::kMicrosecond)
->UseRealTime()
...
BENCHMARK_DEFINE_F(SliceBench, Slice_GPU_OnlyPad)(benchmark::State& st) {
  this->RunGPU(st);
}

BENCHMARK_REGISTER_F(SliceBench, Slice_GPU_OnlyPad)->Iterations(1000)
->Unit(benchmark::kMicrosecond)
->UseRealTime()
...
BENCHMARK_DEFINE_F(SliceBench, Slice_SliceAndPad_CPU)(benchmark::State& st) {
  this->RunCPU(st);
}

BENCHMARK_REGISTER_F(SliceBench, Slice_SliceAndPad_CPU)->Iterations(1000)
->Unit(benchmark::kMicrosecond)
->UseRealTime()
...
BENCHMARK_DEFINE_F(SliceBench, Slice_GPU_SliceAndPad)(benchmark::State& st) {
  this->RunGPU(st);
}

BENCHMARK_REGISTER_F(SliceBench, Slice_GPU_SliceAndPad)->Iterations(1000)
->Unit(benchmark::kMicrosecond)
->UseRealTime()

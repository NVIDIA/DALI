...
#include "dali/operators/reader/loader/dali_video/loader/video_test_base.h"
...
std::vector<std::string> VideoTestBase::cfr_videos_frames_paths_{
  testing::dali_extra_path() + "/db/dali_video/loader/cfr/frames_1/",
  testing::dali_extra_path() + "/db/dali_video/loader/cfr/frames_2/"};

std::vector<std::string> VideoTestBase::vfr_videos_frames_paths_{
  testing::dali_extra_path() + "/db/dali_video/loader/vfr/frames_1/",
  testing::dali_extra_path() + "/db/dali_video/loader/vfr/frames_2/"};

std::vector<std::string> VideoTestBase::vfr_hevc_videos_frames_paths_{
  testing::dali_extra_path() + "/db/dali_video/loader/vfr/frames_1_hevc/",
  testing::dali_extra_path() + "/db/dali_video/loader/vfr/frames_2_hevc/"};

std::vector<std::string> VideoTestBase::cfr_videos_paths_{
  testing::dali_extra_path() + "/db/dali_video/loader/cfr/test_1.mp4",
  testing::dali_extra_path() + "/db/dali_video/loader/cfr/test_2.mp4"};

std::vector<std::string> VideoTestBase::vfr_videos_paths_{
  testing::dali_extra_path() + "/db/dali_video/loader/vfr/test_1.mp4",
  testing::dali_extra_path() + "/db/dali_video/loader/vfr/test_2.mp4"};

std::vector<std::string> VideoTestBase::cfr_hevc_videos_paths_{
  testing::dali_extra_path() + "/db/dali_video/loader/cfr/test_1_hevc.mp4",
  testing::dali_extra_path() + "/db/dali_video/loader/cfr/test_2_hevc.mp4"};

std::vector<std::string> VideoTestBase::vfr_hevc_videos_paths_{
  testing::dali_extra_path() + "/db/dali_video/loader/vfr/test_1_hevc.mp4",
  testing::dali_extra_path() + "/db/dali_video/loader/vfr/test_2_hevc.mp4"};

std::vector<std::string> VideoTestBase::cfr_mpeg4_videos_paths_{
  testing::dali_extra_path() + "/db/dali_video/loader/cfr/test_1_mpeg4.mp4",
  testing::dali_extra_path() + "/db/dali_video/loader/cfr/test_2_mpeg4.mp4"};

std::vector<std::string> VideoTestBase::vfr_mpeg4_videos_paths_{
  testing::dali_extra_path() + "/db/dali_video/loader/vfr/test_1_mpeg4.mp4",
  testing::dali_extra_path() + "/db/dali_video/loader/vfr/test_2_mpeg4.mp4"};

std::vector<std::string> VideoTestBase::cfr_mpeg4_mkv_videos_paths_{
  testing::dali_extra_path() + "/db/dali_video/loader/cfr/test_1_mpeg4.mkv",
  testing::dali_extra_path() + "/db/dali_video/loader/cfr/test_2_mpeg4.mkv"};

std::vector<std::string> VideoTestBase::vfr_mpeg4_mkv_videos_paths_{
  testing::dali_extra_path() + "/db/dali_video/loader/vfr/test_1_mpeg4.mkv",
  testing::dali_extra_path() + "/db/dali_video/loader/vfr/test_2_mpeg4.mkv"};

std::vector<std::string> VideoTestBase::cfr_raw_h264_videos_paths_{
  testing::dali_extra_path() + "/db/dali_video/loader/cfr/test_1.h264",
  testing::dali_extra_path() + "/db/dali_video/loader/cfr/test_2.h264"};

std::vector<std::string> VideoTestBase::cfr_raw_h265_videos_paths_{
  testing::dali_extra_path() + "/db/dali_video/loader/cfr/test_1.h265",
  testing::dali_extra_path() + "/db/dali_video/loader/cfr/test_2.h265"};
...
void VideoTestBase::SaveFrame(
  ...
  int width,
  int height) {
  TensorView<StorageCPU, uint8_t> tv(frame, dali::TensorShape<3>{height, width, 3});
  char str[32];

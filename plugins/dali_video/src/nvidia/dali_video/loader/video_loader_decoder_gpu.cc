...
#include "dali_video/loader/video_loader_decoder_gpu.h"
...
void VideoLoaderDecoderGpu::InitCudaStream() {
  ...
  cuda_stream_ = dali::CUDAStreamPool::instance().Get(device_id_);
}
...
dali::Index VideoLoaderDecoderGpu::SizeImpl() {

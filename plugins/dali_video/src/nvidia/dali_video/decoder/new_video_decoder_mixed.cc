...
#include "dali_video/decoder/new_video_decoder_mixed.h"
...
bool NewVideoDecoderMixed::SetupImpl(
...
void NewVideoDecoderMixed::Run(dali::Workspace &ws) {
...
DALI_REGISTER_OPERATOR(plugin__video__decoders__Video, NewVideoDecoderMixed, dali::Mixed);

...
#include "dali_video/decoder/video_decoder_cpu.h"

namespace dali_video {

bool VideoDecoderCpu::SetupImpl(std::vector<dali::OutputDesc> &output_desc,
...
void VideoDecoderCpu::RunImpl(dali::Workspace &ws) {

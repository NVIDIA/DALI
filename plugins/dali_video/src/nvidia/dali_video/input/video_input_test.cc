...
class VideoInputNextOutputDataIdTest : public ::testing::Test {
 protected:
  ...
  static constexpr bool is_cpu = std::is_same_v<VideoInputBackend, dali::CPUBackend>;
  ...
  const std::vector<TestFileDescriptor> test_files_ = {
          {
                  make_string(testing::dali_extra_path(), "/db/loader/cfr/test_1.mp4"),
                  50,
                  "there will be cake"
          },
          {
                  make_string(testing::dali_extra_path(), "/db/loader/cfr/test_2.mp4"),
                  60,
                  "cake is a lie"
          },
          {
...
using VideoInputTestTypes = ::testing::Types<dali::CPUBackend, MixedBackend>;

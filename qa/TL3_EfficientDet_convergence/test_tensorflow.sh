...
python train.py \
 --epochs 2 --multi_gpu --seed 1234 --pipeline dali_gpu --input coco \
 ...
 --train_batch_size 6 --train_steps 3000 --eval_after_training --eval_during_training \
 --eval_steps 2000 --eval_freq 1

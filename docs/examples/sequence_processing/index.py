doc(title="Video Processing",
    ...
    entries=[
        ...
        doc_entry("video/video_processing_per_frame_arguments.ipynb",
                  [op_reference('fn.readers.video', "Examples of processing video in DALI"),
                   op_reference(
                      'fn.per_frame', "Using per-frame operator to specify arguments to video processing operators"),
                   op_reference(
                   ...
                   op_reference(
                      'fn.rotate', "Specifying per-frame arguments when processing video"),
                   op_reference(
                      'fn.warp_affine', "Specifying per-frame arguments when processing video"),
                   op_reference('fn.transforms', "Specifying per-frame arguments when processing video"), ]),

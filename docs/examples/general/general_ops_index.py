    ...
    entries=[
        ...
        doc_entry(
            ...
            [
                op_reference(
                    "fn.transforms",
                    "Tutorial describing tensor geometric transformations to transform points and images",
                ),
        ...
        doc_entry("erase.ipynb", op_reference("fn.erase", "Tutorial describing tensor erasing")),
    ],
)

...
def InceptionFactoryA(
    data, num_1x1, num_3x3red, num_3x3, num_d3x3red, num_d3x3, pool, proj, name
):
    # 1x1
    c1x1 = ConvFactory(
    ...
    concat = mx.symbol.Concat(
        *[c1x1, c3x3, cd3x3, cproj], name="ch_concat_%s_chconcat" % name
    )
    return concat
...
def InceptionFactoryB(data, num_3x3red, num_3x3, num_d3x3red, num_d3x3, name):
    ...
    # concat
    concat = mx.symbol.Concat(
        *[c3x3, cd3x3, pooling], name="ch_concat_%s_chconcat" % name
    )
    return concat
...
def get_symbol(num_classes, image_shape, **kwargs):
    ...
    if height <= 28:
        ...
        in4c = InceptionFactoryA(
            in4b, 160, 128, 160, 128, 160, "avg", 128, "4c"
        )
        in4d = InceptionFactoryA(in4c, 96, 128, 192, 160, 192, "avg", 128, "4d")
        in4e = InceptionFactoryB(in4d, 128, 192, 192, 256, "4e")
        # stage 4
        in5a = InceptionFactoryA(
            in4e, 352, 192, 320, 160, 224, "avg", 128, "5a"
        )
        in5b = InceptionFactoryA(
            in5a, 352, 192, 320, 192, 224, "max", 128, "5b"
        )
        # global avg pooling
        pool = mx.symbol.Pooling(
            data=in5b,

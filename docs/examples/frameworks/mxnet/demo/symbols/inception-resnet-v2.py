...
def get_symbol(num_classes=1000, **kwargs):
    ...
    conv1a_3_3 = ConvFactory(
        data=data, num_filter=32, kernel=(3, 3), stride=(2, 2)
    )
    ...
    tower_pool3_0 = mx.symbol.Pooling(
        data=maxpool5a_3_3,
        kernel=(3, 3),
        stride=(1, 1),
        pad=(1, 1),
    ...
    tower_pool = mx.symbol.Pooling(
        net, kernel=(3, 3), stride=(2, 2), pool_type="max"
    )
    ...
    net = mx.symbol.Pooling(
        net, kernel=(1, 1), global_pool=True, stride=(2, 2), pool_type="avg"
    )

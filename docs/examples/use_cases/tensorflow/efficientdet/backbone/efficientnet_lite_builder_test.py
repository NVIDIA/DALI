...
class EfficientnetBuilderTest(tf.test.TestCase):
    ...
    def test_efficientnet_b0(self):
        self._test_model_params("efficientnet-lite0", 224, expected_params=4652008)

    def test_efficientnet_b1(self):
        self._test_model_params("efficientnet-lite1", 240, expected_params=5416680)

    def test_efficientnet_b2(self):
        self._test_model_params("efficientnet-lite2", 260, expected_params=6092072)

    def test_efficientnet_b3(self):
        self._test_model_params("efficientnet-lite3", 280, expected_params=8197096)

    def test_efficientnet_b4(self):
        self._test_model_params("efficientnet-lite4", 300, expected_params=13006568)

    ...
    def _make_fake_tfrecord(self):
        ...
        example = tf.train.Example(
            features=tf.train.Features(
                feature={
                    "image/height": tfrecord_util.int64_feature(512),
                    "image/width": tfrecord_util.int64_feature(512),
                    ...
                    "image/key/sha256": tfrecord_util.bytes_feature(
                        "qwdqwfw12345".encode("utf8")
                    ),
                    "image/encoded": tfrecord_util.bytes_feature(encoded_jpg.numpy()),
                    "image/format": tfrecord_util.bytes_feature("jpeg".encode("utf8")),
                    "image/object/bbox/xmin": tfrecord_util.float_list_feature([0.1]),
                    "image/object/bbox/xmax": tfrecord_util.float_list_feature([0.1]),
                    "image/object/bbox/ymin": tfrecord_util.float_list_feature([0.2]),
                    "image/object/bbox/ymax": tfrecord_util.float_list_feature([0.2]),
                    "image/object/class/text": tfrecord_util.bytes_list_feature(
                        ["test".encode("utf8")]
                    ),
                    "image/object/class/label": tfrecord_util.int64_list_feature([1]),
                    "image/object/difficult": tfrecord_util.int64_list_feature([]),
                    "image/object/truncated": tfrecord_util.int64_list_feature([]),
                    "image/object/view": tfrecord_util.bytes_list_feature([]),
                }
            )
        )

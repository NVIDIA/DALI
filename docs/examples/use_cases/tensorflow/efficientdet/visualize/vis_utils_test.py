...
class VisualizationUtilsTest(tf.test.TestCase):
    ...
    def test_draw_bounding_box_on_image_array(self):
        ...
        vis_utils.draw_bounding_box_on_image_array(test_image, ymin, xmin, ymax, xmax)
    ...
    def test_draw_bounding_boxes_on_image_tensors(self):
        ...
        with tf.Graph().as_default():
            ...
            images_with_boxes = vis_utils.draw_bounding_boxes_on_image_tensors(
                images_tensor,
                boxes,
                classes,
                scores,
    ...
    def test_draw_mask_on_image_array(self):
        ...
        vis_utils.draw_mask_on_image_array(test_image, mask, color="Blue", alpha=0.5)

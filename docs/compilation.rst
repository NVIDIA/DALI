...
* | CUDA_VERSION - CUDA toolkit version (10.2 and 11.5 are offiically supported, 10.0, 11.0, 11.1,
    11.2, 11.4, 11.5 and 11.6 are deprecated and may not work).
  | The default is ``11.6``. Thanks to CUDA extended compatibility mode, CUDA 11.1, 11.2, 11.3, 11.4
    11.5 and 11.6 wheels are named as CUDA 11.0 because it can work with the CUDA 11.0 R450.x driver

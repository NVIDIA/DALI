...
class nvJPEGRN50 : public NDLLBenchmark {
};

BENCHMARK_DEFINE_F(nvJPEGRN50, Pipe)(benchmark::State& st) { // NOLINT
  ...
  pipe.AddOperator(
    OpSpec("Caffe2Reader")
    .AddArg("path", "/data/imagenet-compressed/train_480px_lmdb")
...
BENCHMARK_REGISTER_F(nvJPEGRN50, Pipe)->Iterations(100)

...
#ifndef NDLL_PIPELINE_EXECUTOR_PIPELINED_EXECUTOR_H_
#define NDLL_PIPELINE_EXECUTOR_PIPELINED_EXECUTOR_H_
...
#endif  // NDLL_PIPELINE_EXECUTOR_PIPELINED_EXECUTOR_H_

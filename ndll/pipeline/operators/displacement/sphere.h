...
#ifndef NDLL_PIPELINE_OPERATORS_DISPLACEMENT_SPHERE_H_
#define NDLL_PIPELINE_OPERATORS_DISPLACEMENT_SPHERE_H_
...
#endif  // NDLL_PIPELINE_OPERATORS_DISPLACEMENT_SPHERE_H_

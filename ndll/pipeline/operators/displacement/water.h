...
#ifndef NDLL_PIPELINE_OPERATORS_DISPLACEMENT_WATER_H_
#define NDLL_PIPELINE_OPERATORS_DISPLACEMENT_WATER_H_
...
#endif  // NDLL_PIPELINE_OPERATORS_DISPLACEMENT_WATER_H_

...
#ifndef NDLL_PIPELINE_OPERATORS_UTIL_MAKE_CONTIGUOUS_H_
#define NDLL_PIPELINE_OPERATORS_UTIL_MAKE_CONTIGUOUS_H_
...
#endif  // NDLL_PIPELINE_OPERATORS_UTIL_MAKE_CONTIGUOUS_H_

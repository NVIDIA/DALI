...
#ifndef NDLL_PIPELINE_OPERATORS_UTIL_EXTERNAL_SOURCE_H_
#define NDLL_PIPELINE_OPERATORS_UTIL_EXTERNAL_SOURCE_H_
...
#endif  // NDLL_PIPELINE_OPERATORS_UTIL_EXTERNAL_SOURCE_H_

...
#ifndef NDLL_PIPELINE_OPERATORS_UTIL_RANDOMIZER_IMPL_CPU_H_
#define NDLL_PIPELINE_OPERATORS_UTIL_RANDOMIZER_IMPL_CPU_H_
...
#endif  // NDLL_PIPELINE_OPERATORS_UTIL_RANDOMIZER_IMPL_CPU_H_

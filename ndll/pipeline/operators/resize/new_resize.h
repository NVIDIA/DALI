...
#ifndef NDLL_PIPELINE_OPERATORS_RESIZE_NEW_RESIZE_H_
#define NDLL_PIPELINE_OPERATORS_RESIZE_NEW_RESIZE_H_
...
#endif  // NDLL_PIPELINE_OPERATORS_RESIZE_NEW_RESIZE_H_

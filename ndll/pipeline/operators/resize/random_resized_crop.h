...
#ifndef NDLL_PIPELINE_OPERATORS_RESIZE_RANDOM_RESIZED_CROP_H_
#define NDLL_PIPELINE_OPERATORS_RESIZE_RANDOM_RESIZED_CROP_H_
...
#endif  // NDLL_PIPELINE_OPERATORS_RESIZE_RANDOM_RESIZED_CROP_H_

...
#ifndef NDLL_PIPELINE_OPERATORS_READER_MXNET_READER_OP_H_
#define NDLL_PIPELINE_OPERATORS_READER_MXNET_READER_OP_H_

#include "ndll/pipeline/operators/reader/reader_op.h"
#include "ndll/pipeline/operators/reader/loader/recordio_loader.h"
#include "ndll/pipeline/operators/reader/parser/recordio_parser.h"
...
#endif  // NDLL_PIPELINE_OPERATORS_READER_MXNET_READER_OP_H_

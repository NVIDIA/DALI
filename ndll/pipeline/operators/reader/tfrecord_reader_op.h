...
#ifndef NDLL_PIPELINE_OPERATORS_TFRECORD_READER_OP_H_
#define NDLL_PIPELINE_OPERATORS_TFRECORD_READER_OP_H_
...
#endif  // NDLL_PIPELINE_OPERATORS_TFRECORD_READER_OP_H_

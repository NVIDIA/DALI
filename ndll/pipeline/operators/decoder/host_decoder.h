...
#ifndef NDLL_PIPELINE_OPERATORS_DECODER_HOST_DECODER_H_
#define NDLL_PIPELINE_OPERATORS_DECODER_HOST_DECODER_H_
...
#endif  // NDLL_PIPELINE_OPERATORS_DECODER_HOST_DECODER_H_

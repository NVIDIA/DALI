...
#ifndef NDLL_PIPELINE_OPERATORS_DECODER_HYBRID_DECODE_H_
#define NDLL_PIPELINE_OPERATORS_DECODER_HYBRID_DECODE_H_
...
#endif  // NDLL_PIPELINE_OPERATORS_DECODER_HYBRID_DECODE_H_

...
if(BUILD_NVCOMP)
  if (NOT WITH_DYNAMIC_NVCOMP)
    ...
    if(CUDA_VERSION_MAJOR VERSION_LESS_EQUAL "13")
        set(NVCOMP_CUDA_VERSION_MAJOR "12")
      else()
        set(NVCOMP_CUDA_VERSION_MAJOR "${CUDA_VERSION_MAJOR}")
      endif()
    set(DALI_INSTALL_REQUIRES_NVCOMP "\'nvidia-nvcomp-cu${NVCOMP_CUDA_VERSION_MAJOR} ~= 4.0\',")
